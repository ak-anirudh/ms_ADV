...
public abstract class View extends GView {
    ...
    boolean paused;
    int steps;
    protected Vector HoldoverGraphics;
    ...
    protected void setUpExplainationText(String messageToDisplay) {
        ...
        explainationText = createLabel(messageToDisplay,0.75*canvas.width,(canvas.height/18));
    ...
    protected Vector2D[] createPath(Vector2D start, Vector2D finish, int numelements) {
        int i;
