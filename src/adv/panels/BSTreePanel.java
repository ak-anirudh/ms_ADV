...
public class BSTreePanel extends Panel implements DocumentListener, ActionListener {

    private BSTreeView BSTreeView;
    ...
    public BSTreePanel(Window window) {
        super(window);
        ...
        this.add(view = BSTreeView = new BSTreeView());
        setUpAnimationPanel(BSTreeView);
    }

    // Persistence

    public void setData(Object data) {
        BSTreeView.setData(data);
    }

    public Object getData() {
        return BSTreeView.getData();
    }
